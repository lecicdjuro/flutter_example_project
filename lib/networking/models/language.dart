...
String getCode(String desiredLang) {
  var result;
  _languages.forEach((key, value) {
...
bool isSupported(String desiredLang) {
  desiredLang = desiredLang.toLowerCase();
  if (desiredLang is String && _languages.containsKey(desiredLang)) return true;
  return false;
}
